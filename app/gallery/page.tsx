...
const galleryItems = [
  ...
  {
    src: "https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=750&auto=format&fit=crop&q=80&crop=top",
    alt: "Paint roller close-up on wall",
    label: "Feature Wall",
    w: 750,
    h: 900,
  },
  {
    src: "https://images.unsplash.com/photo-1562259929-b4e1fd3aef09?w=750&auto=format&fit=crop&q=80&crop=right",
    alt: "Exterior weatherboard painting project",
    label: "Weatherboard Exterior",
    w: 750,
    h: 500,
  },
  {
    src: "https://images.unsplash.com/photo-1504307651254-35680f356dfd?w=750&auto=format&fit=crop&q=80&crop=bottom",
    alt: "Painted hallway and interior trim",
