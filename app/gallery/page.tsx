...
const galleryItems = [
  ...
  {
    src: "https://images.unsplash.com/photo-1693985120993-e9b203ce7631?w=800&auto=format&fit=crop&q=80",
    alt: "Painter rolling fresh white paint on interior wall",
    label: "Interior Repaint",
    w: 800,
    h: 600,
  },
  {
    src: "https://images.unsplash.com/photo-1613666740417-497352eacd2f?w=800&auto=format&fit=crop&q=80",
    alt: "Professional painting brushes close up",
    label: "Detail Finish Work",
    w: 800,
    h: 1200,
  },
  {
    src: "https://images.unsplash.com/photo-1652829069834-2c05031199c5?w=800&auto=format&fit=crop&q=80",
    alt: "Painter with roller and paint tray on a room repaint job",
    label: "Room Repaint",
    w: 800,
    h: 1200,
  },
